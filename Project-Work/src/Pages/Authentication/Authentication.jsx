...
import { toggleSignUp, togglePasswordVisibility, signUp, selectAuth } from '../../Store/authSlice';
            ...
            <div className={`container ${isSignUp ? 'active' : ''}`}>
                <div className={`panel sign-up ${isSignUp ? 'active' : ''}`}>
                    <form className="container-form">
                        ...
                        <button onClick={cout} type="button" className="button-primary text-lg py-3 px-6">Sign Up</button>
                    </form>
                </div>
                <div className={`panel sign-in ${!isSignUp ? 'active' : ''}`}>
                    <form className="container-form">
                        ...
                        <input type="email" placeholder="Email" className="input-large" />
                        <div className="password-container">
                            <input
                                type={showPassword ? 'text' : 'password'}
                                placeholder="Password"
                        ...
                        <button type="button" className="button-primary text-lg py-3 px-6">Sign In</button>
                    </form>
                </div>
