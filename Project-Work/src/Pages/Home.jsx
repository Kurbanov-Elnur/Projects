    ...
    <div>
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
        <div class="max-w-xl mx-auto text-center py-12">
          ...
          <p class="mt-5 text-base text-gray-800 sm:text-xl">
            Explore our wide range of products, from fresh flowers to unique gifts. Enjoy exclusive offers and easy shopping at your fingertips.
          </p>

          <div
            title="Shop Now"
            class="inline-flex items-center px-6 py-4 mt-8 font-semibold text-white transition-all duration-200 bg-teal-600 rounded-lg hover:bg-teal-700 focus:bg-teal-700"
            role="button"
          >
            Shop Now
      ...
      <div className="py-12">
        <div className="grid grid-cols-1 px-4 sm:px-6 md:px-12 lg:px-24 gap-x-12 gap-y-8 sm:grid-cols-3">
          <div className="cursor-pointer flex items-center p-4 border border-teal-600 rounded-lg shadow-md transition-transform duration-500 transform hover:scale-105 hover:bg-teal-200">
            <svg className="flex-shrink-0 w-8 h-8 text-teal-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 31 25">
            ...
            <p className="ml-3 text-sm text-gray-800">Over 12,000 satisfied customers</p>
          </div>

          <div className="cursor-pointer flex items-center p-4 border border-teal-600 rounded-lg shadow-md transition-transform duration-500 transform hover:scale-105 hover:bg-teal-200">
            <svg className="flex-shrink-0 w-8 h-8 text-teal-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 23 23">
            ...
            <p className="ml-3 text-sm text-gray-800">No annual fees, unlimited options</p>
          </div>

          <div className="cursor-pointer flex items-center p-4 border border-teal-600 rounded-lg shadow-md transition-transform duration-500 transform hover:scale-105 hover:bg-teal-200">
            <svg className="flex-shrink-0 w-8 h-8 text-teal-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 24">
            ...
            <p className="ml-3 text-sm text-gray-800">Secure online shopping experience</p>
          </div>
        </div>
      </div>
